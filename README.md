...
sap-api-integrations-creates は、外部システム(特にエッジコンピューティング環境)をSAPと統合することを目的に、SAP API で 得意先返品データ を登録するマイクロサービスです。  
...
* A_CustomerReturn(SAP 得意先返品 - ヘッダ)
* A_CustomerReturnItem（SAP 得意先返品　- 明細）
